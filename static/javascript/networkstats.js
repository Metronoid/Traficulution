    ...
    UpdateStats(){
        ...
        if(this.show) {
            for (let g in this.generations) {
                ...
                let maxHeight = (canvasHeight / (totalHeight) * (totalHeight)-Math.abs(this.generations[g].max * 2));
                let mediumHeight = (canvasHeight / (totalHeight) * (totalHeight)-Math.abs(this.generations[g].medium * 2));
                let minHeight = (canvasHeight / (totalHeight) * (totalHeight)-Math.abs(this.generations[g].min * 2));
